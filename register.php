...
<header id="header">
    ...
    <div id="logo-group">
        <span id="logo"> <img src="<?php echo ASSETS_URL; ?>/img/logo.png" alt="DJIT"> </span>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 hidden-xs hidden-sm">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <h5 class="about-heading">About Daffodil Japan IT - Are you up to date?</h5>
                        <p>
            ...
            <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
                <div class="well no-padding">
                    ...
                    <form action="<?php echo esc_url($_SERVER['REQUEST_URI']); ?>" method="post" id="smart-form-register" name="registration_form" class="smart-form client-form">
                        <header>
                            Registration Form*
                        </header>
                        ...
                        <fieldset>
                            <section>
                                <label class="input"> <i class="icon-append fa fa-user"></i>
                                    ...
                                    <b class="tooltip tooltip-bottom-right">Needed to enter the System</b> </label>
                            </section>
                            ...
                            <div class="row">
                                ...
                                <section class="col col-6">
                                    <label class="input"> <i class="icon-append fa fa-calendar"></i>
                                        <input type="text" name="dateOfBirth" id="dateOfBirth" placeholder="Date of Birth" class="datepicker" data-dateformat='dd/mm/yy'>
                                    </label>
                                </section>
                            </div>
                        ...
                        <footer>
                            ...
                            if (!empty($error_msg)) {
                                echo '<h5 style="color:red;font-weight: bold;">'.$error_msg.'</h5>';
                            }
                            ?>
                            
                            <button type="button" value="Register" onclick="return regformhash(this.form,
                                            this.form.username,
                                            this.form.email,
                                            this.form.password,
                                            this.form.confirmpwd);" class="btn btn-primary">
                                Register
                            </button>
                        </footer>
                ...
                <p class="note text-center">*FREE Registration ends on October <?= date("Y-m-d") ?>.</p>
                <h5 class="text-center">- Or sign in using -</h5>
                <ul class="list-inline text-center">
                    <li>
                        <a href="https://www.facebook.com/daffodiljapan/" target="_blank" class="btn btn-primary btn-circle"><i class="fa fa-facebook"></i></a>
                    </li>
                    <li>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body custom-scroll terms-body">
                ...
                <div id="left">
                    ...
                    <h1>DAFFODIL JAPAN IT TERMS & CONDITIONS</h1>
                    ...
                    <h2>About these website terms and conditions</h2><p>We created these website terms and conditions with the help of a free website terms and conditions form developed by Contractology and available at <a href="http://www.djit.ac/">www.djit.ac</a>.
                        Contractology supply a wide variety of commercial legal documents, such as <a href="#"> data protection statements</a>.
                    </p>
                ...
                <p><strong>By using this  WEBSITE TERMS AND CONDITIONS document, you agree to the 
                        <a href="#">terms and conditions</a> set out on 
                        <a href="#">www.djit.ac/</a>.  You must retain the credit 
