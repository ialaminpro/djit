                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body status">
                                            ...
                                            <div class="chat-body no-padding profile-message">
                                                <ul>
                                                    <li class="message">
                                                    <?php if($row["photo"]){ $user_photo =$row["photo"];}else{$user_photo="/uploads/img_not_fund/sunny.png"; }?>
                                                        <img src=" <?php echo ASSETS_URL . '/' . $user_photo ; ?>" class="online">
                                                    ...
                                                    if ($result2->num_rows > 0) {
                                                        ...
                                                        while ($comment = $result2->fetch_assoc()) {
                                                            ...
                                                            //echo 
                                                            ?>
                                                            <?php if($comment["photo"]){ $user_photo_com =$comment["photo"];}else{$user_photo_com ="/uploads/img_not_fund/sunny.png"; }?>

                                                            <li class="message" style="margin-left:100px;margin-top:10px;">

                                                                <ul class="list-inline font-xs">
                                                                    <li>
                                                                        <img src="<?php echo ASSETS_URL . '/' . $user_photo_com ; ?>" class="online">
                                                                    </li>
                                                                    <li>  
